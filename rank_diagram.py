...
try:
    ...
    options = {"results": None, "the_algorithm": None, "out": None, "cd": False, "cdt": False, "stat": True}
    ...
    diagram(results, critical_distance_value, options["the_algorithm"], options["out"], options["cd"], options["cdt"],
            options["stat"])
except:
